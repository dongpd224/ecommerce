        ...
        <div className={`container-fluid ${style.category_wrapper}`}>
            <div className='container'>
                <ul className='d-flex justify-content-center'>
                    ...
                    <li><Link href={'/'}><a className={`${style.category_item} d-none d-lg-block`}>Nhà Cửa</a></Link></li>
                    <li><Link href={'/'}><a className={`${style.category_item} d-none d-lg-block`}>Điện Tử</a></Link></li>
                    ...
                    <li><Link href={'/'}><a className={`${style.category_item} d-none d-xl-block`}>Thời Trang Nữ</a></Link></li>
                    <li><Link href={'/'}><a className={`${style.category_item} d-none d-xl-block`}>Thời Trang Nam</a></Link></li>
